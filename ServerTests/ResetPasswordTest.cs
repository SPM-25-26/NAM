...
namespace nam.ServerTests
{
    ...
    public sealed class PasswordResetTests
    {
        ...
        public async Task RequestPasswordReset_EmailNotExists_ReturnsNotFound()
        {
            ...
            var nadRequestResult = (BadRequest<PasswordResetResponseDto>)result;
            Assert.IsNotNull(nadRequestResult.Value);
            Assert.IsFalse(nadRequestResult.Value.Success);
            Assert.AreEqual("The email not found", nadRequestResult.Value.Message);
