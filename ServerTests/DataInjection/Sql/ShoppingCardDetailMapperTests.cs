...
{
    [TestFixture]
    public class ShoppingCardDetailMapperTests
    {
        [Test]
        public void MapToEntity_ReturnsNewIdentifier_WhenDtoNull()
        {
            var mapper = new ShoppingCardDetailMapper();
        ...
        {
            var mapper = new ShoppingCardDetailMapper();
            var identifier = Guid.Parse("88888888-8888-8888-8888-888888888888");

            var dto = new ShoppingCardDetailDto
            {
                ...
                Services = new List<PointOfSaleServiceDto?> { new() { Name = " S ", Description = " D " } },
                SellingTypicalProducts = new List<TypicalProductDto?> { new() { Identifier = Guid.NewGuid().ToString(), Name = " P " } },
            ...
            NUnitAssert.That(result.SellingTypicalProducts, Has.Count.EqualTo(1));
