...
{
    public class MunicipalityCardService(IMunicipalityCardRepository municipalityCardRepository) : IMunicipalityEntityService<MunicipalityCard, MunicipalityHomeInfo>
    {
