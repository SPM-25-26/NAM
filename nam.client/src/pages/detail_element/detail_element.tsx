            ...
            <Container key={paragraph.position}>
              ...
              {paragraph.referenceImagePath && (
                <CardMedia
                  ...
                  // Using direct URL construction allows the Service Worker to handle caching
                  image={buildApiUrl(
      ...
      <Box sx={{ width: "100%" }}>
        ...
        {data.organizationFacebook && (
          <DetailRow
            ...
            text={data.organizationFacebook.replace(
        ...
        {data.organizationInstagram && (
          <DetailRow
            ...
            text={data.organizationInstagram.replace(
